...
public class Busca extends javax.swing.JFrame {
     ...
     */
    private Controller.controllerBusca buscaController;
    private Model.Musica musicaEncontrada;
    
    public Busca() {
        initComponents();
        buscaController = new Controller.controllerBusca();
    }
    ...
    private void botaoBuscarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_botaoBuscarActionPerformed
        ...
        musicaEncontrada = buscaController.buscarMusica(termo);
    ...
    private void botaoCurtirActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_botaoCurtirActionPerformed
        // TODO add your handling code here:
        if (musicaEncontrada != null) {
            boolean sucesso = buscaController.curtirMusica(musicaEncontrada);
            if (sucesso) {
    ...
    private void botaoDescurtirActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_botaoDescurtirActionPerformed
        ...
        if (sucesso) {
            javax.swing.JOptionPane.showMessageDialog(this, "Música descurtida com sucesso!");
        } else {
            javax.swing.JOptionPane.showMessageDialog(this, "Erro ao curtir música.");
        }
    } else {
