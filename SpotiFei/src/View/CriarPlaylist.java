...
import Controller.CriarPlaylistController;
...
public class CriarPlaylist extends javax.swing.JFrame {
     ...
     */
    private CriarPlaylistController criarPlaylistController;
    
    public CriarPlaylist() {
        initComponents();
        criarPlaylistController = new CriarPlaylistController();
    }
    ...
    private void botaoCriarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_botaoCriarActionPerformed
        ...
        boolean sucesso = criarPlaylistController.criarPlaylist(nomePlaylist);
