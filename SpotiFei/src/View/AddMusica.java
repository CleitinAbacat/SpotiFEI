...
import Controller.AddMusicaController;
...
public class AddMusica extends javax.swing.JFrame {
     ...
     */
    private AddMusicaController addMusicaController;
    
    public AddMusica() {
        initComponents();
        addMusicaController = new AddMusicaController();
    }
    ...
    private void botaoAdicionarMusicaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_botaoAdicionarMusicaActionPerformed
        ...
        String resultado = addMusicaController.adicionarMusicaNaPlaylist(nomePlaylist, nomeMusica);
        JOptionPane.showMessageDialog(this, resultado);

        if (resultado.equals("Música adicionada com sucesso!")) {
