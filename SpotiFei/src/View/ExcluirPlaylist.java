...
import Controller.ExcluirPlaylistController;
...
public class ExcluirPlaylist extends javax.swing.JFrame {
     ...
     */
    private ExcluirPlaylistController excluirPlaylistController;

    public ExcluirPlaylist() {
        initComponents();
        excluirPlaylistController = new ExcluirPlaylistController();
    }
    ...
    private void botaoExcluirActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_botaoExcluirActionPerformed
        ...
        String resultado = excluirPlaylistController.excluirPlaylist(nomePlaylist);
        JOptionPane.showMessageDialog(this, resultado);

        if (resultado.equals("Playlist excluída com sucesso!")) {
