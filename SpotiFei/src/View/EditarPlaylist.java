...
import Controller.EditarPlaylistController;
...
public class EditarPlaylist extends javax.swing.JFrame {
     ...
     */
    private EditarPlaylistController editarPlaylistController;

    public EditarPlaylist() {
        initComponents();
        editarPlaylistController = new EditarPlaylistController();
    }
    ...
    private void botaoEditarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_botaoEditarActionPerformed
        ...
        String resultado = editarPlaylistController.editarPlaylist(nomeAtual, novoNome);
        JOptionPane.showMessageDialog(this, resultado);

        if (resultado.equals("Nome da playlist atualizado com sucesso!")) {
